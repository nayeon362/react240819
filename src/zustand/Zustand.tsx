...
// - Redux의 고질적 문제점인 복잡ㅎ나 코드 구조 및 학습 곡선이 그 이유
// - zustand는 단순한 코드 구조와 학습 곡선이 매우 낮음
// - Redux, MobX 등과 같은 타 패키지에 비해 가벼움 - 빌드 시 패키징 속도가 굉장히 빠름 / 번들의 크키가 줄어듬
...
// const [address, setAddress] = usestore<String>('');
...
export default function Zustand() {
    ...
    // const { 상태, ..., 상태 변경 함수, ...} = useStore훅 함수();
